          ...
          <div className="p-3 rounded-md bg-slate-700">
            ...
            <div className="mt-8 text-center text-white px-4 sm:px-8 md:px-32">
              <p className="text-lg mb-4">
                ...
                Enjoy the perfect blend of luxury and nature with spacious interiors,
                a modern design, and breathtaking views.
              </p>
              <h3 className="text-2xl font-semibold mb-6">Wanna live your dream?</h3>
